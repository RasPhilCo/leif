...
@rasphilco/leif/0.4.0 darwin-x64 node-v12.14.1
$ leif --help [COMMAND]
USAGE
  $ leif COMMAND
...
...
_See code: [src/commands/cleanup.ts](https://github.com/RasPhilCo/leif/blob/v0.4.0/src/commands/cleanup.ts)_
...
_See code: [src/commands/run.ts](https://github.com/RasPhilCo/leif/blob/v0.4.0/src/commands/run.ts)_
<!-- commandsstop -->
