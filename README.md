...
@rasphilco/leif/0.6.3 darwin-x64 node-v12.14.1
$ leif --help [COMMAND]
USAGE
  $ leif COMMAND
...
...
_See code: [src/commands/cleanup.ts](https://github.com/RasPhilCo/leif/blob/v0.6.3/src/commands/cleanup.ts)_
...
_See code: [src/commands/run.ts](https://github.com/RasPhilCo/leif/blob/v0.6.3/src/commands/run.ts)_
<!-- commandsstop -->
